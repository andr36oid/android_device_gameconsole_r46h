...
cp ../common/resizing/prebuilt/Image-recovery BOOT/ || true
cp "$OUTDIR/obj/KERNEL_OBJ/arch/arm64/boot/dts/rockchip/rk3326-$DEVICE.dtb" BOOT/rk3326-r46h-android.dtb || true
